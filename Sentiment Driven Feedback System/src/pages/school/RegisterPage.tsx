...
const RegisterPage = () => {
  ...
  if (isAuthenticated) {
    ...
    return <Navigate to="/school/student-dashboard" />;
  }
      ...
      <div className="max-w-3xl mx-auto">
        <div className="mb-8 text-center">
          ...
          <p className="text-slate-600">
            {userType === 'admin' 
              ? 'Register as an administrator to manage the school feedback system'
              : 'Register to access the school feedback system'}
          </p>
        </div>

        <RegisterForm userType={userType} institutionType="school" />
      </div>
    </div>
  );
};
