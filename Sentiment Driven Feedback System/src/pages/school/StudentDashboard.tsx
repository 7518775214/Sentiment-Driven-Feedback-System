...
const StudentDashboard = () => {
  ...
  useEffect(() => {
    if (!isAuthenticated) {
      ...
      navigate('/school/login?type=student');
    }
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-4xl mx-auto">
        {/* Welcome Section */}
        <div className="bg-gradient-to-r from-primary to-primary-dark text-white p-6 rounded-lg shadow-md mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <div className="bg-white p-5 rounded-lg shadow-md border border-slate-200">
            <div className="flex items-start">
              ...
              <div>
                <h3 className="text-lg font-semibold text-slate-900">Your School</h3>
        ...
        <div className="bg-slate-50 p-6 rounded-lg border border-slate-200">
          ...
          <p className="text-slate-600 mb-4">
            Your honest feedback helps us improve future events and activities. All feedback is analyzed using sentiment analysis to identify areas where we excel and areas that need improvement.
          </p>
