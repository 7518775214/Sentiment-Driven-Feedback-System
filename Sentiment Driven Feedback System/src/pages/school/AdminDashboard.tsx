...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    if (!isAuthenticated) {
      ...
      navigate('/school/login?type=admin');
    }
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-slate-50 p-6 rounded-lg border border-slate-200">
          ...
          <p className="text-slate-600 mb-4">
            Our system uses Natural Language Processing (NLP) to analyze feedback text and detect sentiment. This helps identify what aspects of an event were well-received and what needs improvement.
          </p>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
            <div className="bg-white p-4 rounded border border-slate-200">
              <h4 className="font-medium text-slate-800 mb-2">1. Feedback Collection</h4>
              <p className="text-sm text-slate-600">Students submit feedback through the forms, rating events and providing comments.</p>
            </div>
          ...
          <p className="text-slate-600">
            Use these insights to make data-driven decisions about future events and activities to improve student satisfaction.
          </p>
        </div>
      </div>
    </div>
